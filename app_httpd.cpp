...
#if CONFIG_LED_ILLUMINATOR_ENABLED
  // ในเวอร์ชัน 2.x ต้องตั้งค่า Channel ก่อน (ledcSetup) แล้วค่อยผูกกับขา Pin (ledcAttachPin)
  ledcSetup(0, 5000, 8); // (ช่องที่ 0, ความถี่ 5000Hz, ความละเอียด 8 บิต)
  ledcAttachPin(pin, 0); // ผูกขา pin เข้ากับช่องที่ 0
#else
